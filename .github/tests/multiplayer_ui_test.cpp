...
int main() {
	...
	// Public projections expose Graveyards and face-up public cards, but never
	// leak Deck top, Hand, face-down Extra or face-down banished identities.
	...
	write_u32(2);
	write_u32(999);
	write_u32(101); write_u32(0x1);
	write_u32(102); write_u32(0x8);
	write_u32(201); write_u32(0x1);
	write_u32(202); write_u32(0x8);
	write_u32(1);
	write_u32(2);
	write_u32(301); write_u32(0x1);
	write_u32(401); write_u32(0x1);
	write_u32(402); write_u32(0x8);
	assert(ygo::multiplayer_packets::SanitizePrivatePiles(
		piles.data(), piles.size(), 0x5));
	assert(read_u32(17) == 0);
	assert(read_u32(21) == 0 && read_u32(29) == 0);
	assert(read_u32(37) == 201 && read_u32(45) == 0);
	assert(read_u32(61) == 301);
	assert(read_u32(69) == 401 && read_u32(77) == 0);
