...
# High 0x80 uniquely marks Big Five 2v1. Because the public flag intentionally
# also carries the protected 3v1 bit (0x40), always prefer the 2v1 sizing first.
replace_once(
...
print("Applied safe Big Five 2v1 sizing to WindBot")
